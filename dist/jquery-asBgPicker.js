    ...
    var Repeat = function() {
      ...
      _createClass(Repeat, [{
        ...
        value: function init() {
          ...
          var tplContent = this.instance.options.repeat.tpl().replace(/\{\{namespace\}\}/g, this.instance.namespace).replace(/\{\{strings.bgRepeat\}\}/g, this.instance.strings.bgRepeat);
          ...
          var value = typeof this.instance.value.repeat !== 'undefined' ? this.instance.value.repeat : this.defaultValue;
          this.set(value);
    ...
    var Size = function() {
      ...
      _createClass(Size, [{
        ...
        value: function init() {
          ...
          var tplContent = this.instance.options.size.tpl().replace(/\{\{namespace\}\}/g, this.instance.namespace).replace(/\{\{strings.bgSize\}\}/g, this.instance.strings.bgSize);
          ...
          var value = typeof this.instance.value.size !== 'undefined' ? this.instance.value.size : this.defaultValue;
          this.set(value);
    ...
    var Position = function() {
      ...
      _createClass(Position, [{
        ...
        value: function init() {
          ...
          var tplContent = this.instance.options.position.tpl().replace(/\{\{namespace\}\}/g, this.instance.namespace).replace(/\{\{strings.bgPosition\}\}/g, this.instance.strings.bgPosition);
          ...
          var value = typeof this.instance.value.position !== 'undefined' ? this.instance.value.position : this.defaultValue;
          this.set(value);
    ...
    var Attachment = function() {
      ...
      _createClass(Attachment, [{
        ...
        value: function init() {
          ...
          var tplContent = this.instance.options.attachment.tpl().replace(/\{\{attachNamespace\}\}/g, this.instance.options.attachment.namespace).replace(/\{\{namespace\}\}/g, this.instance.namespace).replace(/\{\{strings.bgAttach\}\}/g, this.instance.strings.bgAttach);
          ...
          var value = typeof this.instance.value.attachment !== 'undefined' ? this.instance.value.attachment : this.defaultValue;
          this.set(value);
        }
      }, {
        key: 'set',
      ...
      return this.each(
        ...
        function() {
          if (!(0, _jquery2.default)(this).data(NAMESPACE)) {
            (0, _jquery2.default)(this).data(NAMESPACE, new asBgPicker(this, options));
          }
        }
      );
    };
